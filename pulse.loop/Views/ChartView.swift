...
//import Combine
//
//struct ChartView<CharacteristicType: GeneralCharacteristicProtocol<RawOpticalData>>: View {
//
...
//            ChartView(value: device.sensorData.aggregatedData, dataSets: [.led2], windowLength: 3, title: "Chart")
//                .padding()
//        }
